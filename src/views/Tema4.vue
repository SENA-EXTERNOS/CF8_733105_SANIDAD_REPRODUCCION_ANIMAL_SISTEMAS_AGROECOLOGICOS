...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.container.justify-content-around.align-items-align-items-center
        ...
        p Una vez garantizado el bienestar animal, puede centrarse en otras actividades como la reproducción de las especies. La reproducción es el fenómeno central de la vida y desempeña un papel fundamental en la preservación de estas. A través de este proceso, los seres vivos se multiplican y dan origen a nuevos seres. 
          br
          br
          |A continuación, se describe el aparato reproductor masculino:
    ...
    .row.container.justify-content-around.align-items-align-items-center
        ...
        p El origen de un nuevo ser se determina por la unión de dos células germinales, la masculina que es el espermatozoide, y la femenina, que es óvulo, así, se obtiene un huevo o cigoto, que terminará en la formación de un nuevo individuo. 
          br
          br
          |A continuación, se describirá el aparato reproductor femenino:
    ...
    .row.container.justify-content-around.align-items-align-items-center
        ...
        p En los animales mamíferos, las hembras, hasta la pubertad, no pueden preñarse, lo que solo es posible cuando los ovarios se encuentran maduros. El proceso de ovulación está ligado a la alimentación, a factores genéticos y a factores ambientales durante el levante, ya que afectan el estado hormonal y el peso corporal de la vaca para su adecuada reproducción.
          br
          br
          |Se describen las características particulares del ciclo estral de las diferentes especies de importancia pecuaria de la siguiente manera:
    ...
    .row.container.justify-content-around.align-items-align-items-center
        ...
        p Para que se produzca el celo en la hembra, es necesario que el hipotálamo, la hipófisis y los ovarios generen hormonas e interactúen, de forma sincronizada, para dar inicio a los procesos reproductivos.
          br
          br
          |Para iniciar el ciclo estral en animales jóvenes, es indispensable acelerar la producción de andrógenos; de esta forma, comienza la etapa de la pubertad del animal, alcanzando su madurez sexual. A este punto se le conoce como madurez somática, listas para ser servidas. Se describen algunos métodos y técnicas para detectar el celo; veamos:
