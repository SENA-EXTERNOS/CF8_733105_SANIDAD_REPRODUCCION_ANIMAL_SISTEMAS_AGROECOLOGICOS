...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.mb-5
      .col-lg-7
        p Es importante conocer la anatomía de los animales, las diferencias en su funcionamiento y su cometido dentro de las etapas productivas en cuanto al manejo, la alimentación y los cuidados a tener en cuenta. A continuación, se profundiza en esta temática:
          br
          br
          | La anatomía animal se encarga de estudiar tanto la forma y las estructuras de los órganos que conforman un sistema, como su relación dentro del organismo, lo que hace posible conocer el funcionamiento de cada uno de ellos.
        .cajon.color-primario.p-4.mb-4(style="background-color: #fff2df ")
          p.mb-0 Dentro de los sistemas anatómicos del cuerpo animal se encuentra el sistema músculo esquelético, el sistema cardiovascular, el sistema respiratorio, el sistema digestivo, el sistema urinario y el sistema reproductor.
      .col-lg-5: img(src='@/assets/curso/temas/c1.png', alt='')
    ...
    .row.container.justify-content-around.align-items-align-items-center
        ...
        p Ahora, se describen algunas enfermedades comunes que se presentan en porcinos para producción pecuaria, junto a sus agentes causantes:
    ...
    .row.container.justify-content-around.align-items-align-items-center
        ...
        p El deterioro del bienestar, la salud y la productividad en los animales, puede estar originado por agentes causantes de enfermedades que deben ser manejados conforme a un plan sanitario, el cual está dirigido, básicamente, a controlar, prevenir y erradicar enfermedades que afecten los sistemas de producción agropecuaria. Su objetivo es el de reforzar los trabajos de manejo y diagnóstico, con el fin de disminuir los riesgos que afectan la sanidad del hato.
          br
          br
          |A continuación, se describe el plan de vacunación para los bovinos:
    ...
    .row.container.justify-content-around.align-items-align-items-center
        ...
        p El plan sanitario de vacunación para los cerdos, se describe de la siguiente manera:
